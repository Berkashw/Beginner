const humanOne = {age:33, name:'Al',country:'Russia',adult:false, employee:true}
const humanTwo = {age:17, name:'Bad',country:'Mars',adult:false, employee:false}
class Person {
    constructor(human){
        this.age = human.age  
...
class Employee extends Person {
    ...
    employeeCheck = () => {
        if (this.employee) {console.log('Welcome ' + this.name)}
        else { 
